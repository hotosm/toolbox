...
*If you are not using a server, skip to **2. Set the Image Size***
...
*If you are not using a server and surveys were manually uploaded to the device, skip to **2. Fill the Survey Form***
...
### Upload or Download Survey Forms
...
**1. Upload Survey Forms to Server**
...
**2. Upload Survey Form to Google Drive**
