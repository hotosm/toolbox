...
Each of these elements can be added by opening the ‘Layout’ menu on the top toolbar or by using the quick access buttons on the left-hand toolbar. 
